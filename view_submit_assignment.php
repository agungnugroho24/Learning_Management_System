                     ...
                     <div class="row-fluid">
					   ...
					   <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Tugas yang dikirim</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									?>
									<div class="alert alert-info">Klik tugas masuk : <?php echo $row1['fname']; ?></div>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
									...
									?>                              
										<tr>
										 ...
										 <button name="save" class="btn btn-success" id="btn_s"><i class="icon-save"></i> Simpan</button>
										 </form>
										 </td>                                                                        
                                </tr>
