...
<a   class="main" href="javascript:chat_login(true);">Masuk</a>
<?php } ?>
<?php if (count($chat_list) >= 2) { ?>
<div class="main" id="room_parent">Ruangan</div>
<?php } ?>
...
<tr>
  ...
  <td>
    <div id="header_users">Admin</div>
    <div id="users">
      <?php if (count($chat_list) >= 2) { ?>
      <b class="first">Pesan privasi</b><div id="users_priv"></div>
      <?php } ?>
      <?php if (count($chat_list) == 1) { ?>
      <b class="first">Pesan privasi</b><div id="users_priv"></div>
      <b class="other">Admin       </b><div id="users_this"></div><div id="users_othr"></div>
      <?php } ?>
    </div>
  </td>
</tr>
...
<div class="menu_form_exit" id="color_exit">&nbsp;</div>Warna
</div>
<div class="menu_form_body">
...
<div class="menu_form_exit" id="login_exit">&nbsp;</div>Verifikasi
</div>
<div class="menu_form_body">
...
<form action="" onsubmit="chat_msgs_log(true); return false;">
  ...
  <div class="form_title">Nama depan:</div>
  <div class="form_input"><div class="input"><input id="user" type="text" /></div></div>
  <table class="form_separator"><tr><td></td></tr></table>

  <div class="form_title">Nama belakang:</div>
  <div class="form_input"><div class="input"><input id="pass" type="text" /></div></div>
  <table class="form_separator"><tr><td></td></tr></table>
...
<div class="menu_form_exit" id="smiley_exit">&nbsp;</div>Emoticon
</div>
<div class="menu_form_body">
