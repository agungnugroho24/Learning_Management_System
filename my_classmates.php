        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
					...
					?>
					     <ul class="breadcrumb">
							<li><a href="#"><font color="#fff"><?php echo $row['class_name']; ?></a> <span class="divider"></span></font></li>
							<li><a href="#"><font color="#fff"><?php echo $row['subject_code']; ?></a> <span class="divider"></span></font></li>
							<li><a href="#"><font color="#fff"><?php echo $row['school_year']; ?></a> <span class="divider"></span></font></li>
							<li><a href="#"><font color="#fff"><b>Teman sekelasku</b></a></font></li>
						</ul>
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div id="" class="muted pull-left"><ul class="breadcrumb">
							<li><a href="#"><b>Teman sekelasku</b></a></li>
						</ul></div>
                            </div>
