                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Materi yang bisa diunduh</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
							...
							Pilih semua <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								<?php
									...
									$count = mysql_num_rows($query);	
								if ($count == '0'){ ?>
								<div class="alert alert-info"><i class="icon-info-sign"></i> Tidak ada materi yang bisa diunduh.</div>
								<?php
								}else{
								?>
									...
									<a data-toggle="modal" href="#user_delete" id="delete"  class="btn btn-info" name=""><i class="icon-copy"></i> Duplikasi yang dipilih</a>
