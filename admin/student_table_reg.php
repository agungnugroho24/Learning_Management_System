  ...
  <script src="bootstrap.min.js"></script>
	...
	<?php include('modal_delete.php'); ?>
		...
		<?php
	$query = mysql_query("select * from student LEFT JOIN class ON student.class_id = class.class_id where class_name = 'Kelas 3A' ORDER BY student.student_id DESC") or die(mysql_error());
