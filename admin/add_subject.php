		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Tambah subjek</div>
		                            </div>
									...
									<a href="subjects.php"><i class="icon-arrow-left"></i> Kembali</a>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" name="subject_code" id="inputEmail" placeholder="Kode subjek">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="inputPassword">Judul subjek</label>
											<div class="controls">
											<input type="text" class="span8" name="title" id="inputPassword" placeholder="Judul subjek" required>
											</div>
										</div>
										<div class="control-group">
