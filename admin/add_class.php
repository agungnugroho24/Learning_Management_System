                            ...
                            <div class="block-content collapse in">
								...
								<form method="post">
										<div class="control-group">
                                          <div class="controls">
                                            <input name="class_name" class="input focused" id="focusedInput" type="text" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ123456789 ',this)" placeholder = "Nama kelas" required>
                                          </div>
                                        </div>
