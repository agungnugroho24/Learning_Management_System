...
<html lang="EN">
	...
	<body>
	<div class="holder">
		<label="welcomemsg">Selamat datang: </label><label for="name"><?php echo $firstname; ?></label>
			<div class="style">	
				<div class="alpha">
					<b align="center"></b>
					<input name="user" type="hidden" id="texta" value="<?php echo $firstname ?>"/>
					<div class="refresh">
					</div>
					<br/>
							...
							<option>Kepada</option>
								<?php 
									...
									foreach ($fetch as $fe):
										$name = $fe['firstname'];
								?>
									<option title="<?php echo $name; ?>"><?php echo $fe['firstname']; ?> </option>
								<?php endforeach; ?>
						</select>
					<textarea name="textb" id="textb">Ketik pesan disini</textarea>
