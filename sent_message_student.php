                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
										...
										<li class="active"><a href="sent_message_student.php"><i class="icon-envelope-alt"></i>Pesan terkirim</a></li>
										</ul>
								...
								<?php }}else{ ?>
								<div class="alert alert-info"><i class="icon-info-sign"></i> Tidak ada pesan di pesan terkirim</div>
								<?php } ?>	
                                </div>
                            </div>
                        </div>
