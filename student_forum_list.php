                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 		$query = mysql_query("select * FROM class_quiz 
										LEFT JOIN diskusi on class_quiz.quiz_id = quiz.quiz_id
										where teacher_class_id = '$get_id'  ")or die(mysql_error());
                                ...
                                <div class="span12">
									...
									<?php include('copy_to_backpack_modal.php'); ?>
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
										<thead>
												...
												<th>Judul ulangan</th>
												<th>Penjelasan</th>
												<th>Waktu ulangan (dalam menit)</th>
												<th></th>
												</tr>
										</thead>
										<tbody>
									...
									?>                              
										<tr>                     
                                         ...
                                         <td width="200">
										<?php if ($grade == ""){ ?>
											<a  data-placement="bottom" title="Take This Quiz" id="<?php echo $id; ?>Download" href="take_test.php<?php echo '?id='.$get_id ?>&<?php echo 'class_quiz_id='.$id; ?>&<?php echo 'test=ok' ?>&<?php echo 'quiz_id='.$quiz_id; ?>&<?php echo 'quiz_time='.$quiz_time;	 ?>"><i class="icon-check icon-large"></i> Ikut ulangan</a>
										<?php }else{ ?>
										<b>Sudah dinilai <?php echo $grade; ?></b>
										<?php } ?>
										</td>            
