                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Latihan ulangan</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
...
?>
										<h3>Judul ulangan: <b><?php echo $rowa['quiz_title'];?></b></h3>
										<p><b>Penjelasan:<?php echo $rowa['quiz_description'];?></b></p>
										<p></p>
										Sisa waktu:<div id="timer">1</div>
										<div id="msg"></div>
					<script>
					jQuery(document).ready(function(){	
...
?>
	<input name="q-<?php echo $roww['quiz_question_id'];?>" value="True" type="radio"> Benar&nbsp;|&nbsp;<input name="q-<?php echo $roww['quiz_question_id'];?>" value="False" type="radio"> Salah
<?php
...
?>
<br/>
<button onclick="return false;" qn="<?php echo $x;?>" class="nextq btn btn-success" id="next_<?php echo $x;?>">Pertanyaan berikutnya <i class="icon-arrow-right"></i> </button>
...
<td></td>
<td>
<button class="btn btn-info" id="submit-test" name="submit_answer"><i class="icon-check"></i> Kirim jawaban</button>
...
<?php
	...
	<center>
	<h3><br>Nilai anda <b><?php echo $score; ?></b> dari <b><?php echo ($x-1); ?></b><br/></h3>
	</center>
	<?php
