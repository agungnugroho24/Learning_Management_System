            ...
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
						...
						?>
							<li><a href="#"><font color="#fff"><b>Kelasku</b></a><span class="divider"> / </span></font></li>
							<li><a href="#"><font color="#fff">Tahun ajaran: <?php echo $school_year_query_row['school_year']; ?></a></font></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<?php }}else{ ?>
									<div class="alert alert-info"><i class="icon-info-sign"></i> Tidak termasuk ke kelas manapun</div>
									<?php } ?>	
									</ul>
