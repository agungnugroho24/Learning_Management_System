            ...
            <div class="row-fluid">
                ...
                <div class="span4" id="content">
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Perkembangan</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							    <div id="" class="muted pull-left"><h4> Perkembangan tingkat tugas</h4></div>
							</div>
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							    <div id="" class="muted pull-left"><h4> Perkembangan latihan ulangan</h4></div>
							</div>
                            <div class="block-content collapse in">
                                <div class="span12">
