					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<a href="announcements.php<?php echo '?id='.$get_id; ?>"><i class="icon-arrow-left icon-large"></i> Kembali</a>
								<br>
								<br>
								<form method="post">
									 <?php
								...
								<br>
								<button name="post" class="btn btn-info"><i class="icon-check icon-large"></i> Pengumuman baru</button>
								</form>
                                </div>
