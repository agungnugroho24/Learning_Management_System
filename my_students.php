                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
						<div class="pull-right">
							<a href="add_student.php<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i class="icon-plus-sign"></i> Tambah murid</a>
							<a onclick="window.open('print_student.php<?php echo '?id='.$get_id; ?>')"  class="btn btn-success"><i class="icon-list"></i> Daftar murid</a>
						</div>
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								Jumlah murid: <span class="badge badge-info"><?php echo $count_my_student; ?></span>
								</div>
                            </div>
													...
													$(document).ready( function() {
														...
														var id = $(this).attr("id");
															...
															success: function(html){
																...
																$('#'+id).modal('hide');
																$.jGrowl("Berhasil dihapus", { header: 'Hapus murid' });
															}
															}); 	
															return false;
														});				
