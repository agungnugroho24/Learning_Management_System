                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									<a href="add_quiz.php" class="btn btn-info"><i class="icon-plus-sign"></i> Tambah ulangan</a>
									<td width="30"><a href="add_quiz_to_class.php" class="btn btn-success"><i class="icon-plus-sign"></i> Tambah kuis ke kelas</a></td>   
									</div>
