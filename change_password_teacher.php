                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
					     <ul class="breadcrumb">
								...
								?>
								<li><a href="#"><b>Ganti kata sandi</b></a><span class="divider">/</span></li>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
  								<div class="alert alert-info"><i class="icon-info-sign"></i> Isi semua detil</div>
								<?php
								...
								?>								
								    ...
								    <form  method="post" id="change_password" class="form-horizontal">
										<div class="control-group">
											<label class="control-label" for="inputEmail">Kata sandi sebelumnya</label>
											<div class="controls">
										...
										<div class="control-group">
											<label class="control-label" for="inputPassword">Klangi kata sandi</label>
											<div class="controls">
