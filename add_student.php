            ...
            <div class="row-fluid">
				...
				<div class="pull-right">
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#">Muridku</a><span class="divider">/</span></li>
							<li><a href="#"><b>Tambah murid</b></a></li>
						</ul>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									<form method="post" action="">
										...
										<button name="submit" type="submit" class="btn btn-info"><i class="icon-save"></i>&nbsp;Tambah murid</button>
												<br>
												<br>
