...
<div id="reply<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		...
		<div class="control-group">
			<label class="control-label" for="inputEmail">Kepada:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="inputPassword">Isi:</label>
			<div class="controls">
		...
		<div class="control-group">
			<div class="controls">
			<button type="submit" name="reply" id="<?php echo $id; ?>" class="btn btn-success reply"><i class="icon-reply"></i> Balas</button>
			</div>
		</div>
