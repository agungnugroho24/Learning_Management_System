							...
							Pilih semua <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									...
									<?php
										...
										if ($count == '0'){ ?>
											<div class="alert alert-info"><i class="icon-info-sign"></i> Tidak materi yang bisa diunduh</div>
						
									<?php	}else{
									?>  
  								<form action="copy_file.php" method="post">
								
									<a data-toggle="modal" href="#user_delete" id="delete"  class="btn btn-info" name=""><i class="icon-file"></i> Duplikasi yang dipilih</a>
